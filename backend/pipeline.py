...
def process_email(email_id):
    ...
    # ==========================================================
    # 7. DETECT ACTUAL DOCUMENT TYPES
    # ==========================================================

    si_document_type = detect_document_type(
        si_text
    )

    bl_document_type = detect_document_type(
        bl_text
    )

    # ==========================================================
    # 8. VERIFY DOCUMENT TYPES
    # ==========================================================

    if si_document_type != "SHIPPING_INSTRUCTION":
        ...
        return {
            ...
            "status": "NEEDS_REVIEW",
            "reason": (
                "Expected Shipping Instruction, "
                f"but detected {si_document_type}"
            ),
            "document_types": {
                "SI": si_document_type,
                "BL": bl_document_type,
    ...
    if bl_document_type != "BILL_OF_LADING":
        ...
        return {
            ...
            "status": "NEEDS_REVIEW",
            "reason": (
                "Expected Draft Bill of Lading, "
                f"but detected {bl_document_type}"
            ),
            "document_types": {
                "SI": si_document_type,
                "BL": bl_document_type,
    ...
    # ==========================================================
    # 11. CHECK FOR MISSING REQUIRED VALUES
    # ==========================================================
